...
(string result) run_obj(string custom_parameters, int rf_iteration, int parameter_iteration, int num_replications, string executable, string default_xml_loc)
{
...
// below
(void o) start (int ME_rank, int num_iterations, int num_estimators, int num_init_population, int num_population, int num_variations, int random_seed, string rf_parameters_file, string executable_model, string default_xml_loc) {
    ...
    EQPy_init_package(ME,"rand_forest_comp") =>
    EQPy_get(ME) =>
...
main() {
  ...
  start(rank, num_iterations, num_estimators, num_init_population, num_population, num_variations, random_seed, rf_parameters_file, executable, default_xml_loc);
}
